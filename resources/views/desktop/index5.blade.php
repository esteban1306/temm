...
@section('content')
                ...
                <div class="col-12"  style="overflow:  auto;">
                    <table class="table responsive" id="clientes-list-table">
                        ...
                        <tr>
                            ...
                            <th class="min-tablet">Soat</th>
                            <th class="min-tablet">Tecnomecanica</th>
    ...
    @include('product.modal_venta_lav')
    ...
    @include('customer.modal_add_lav')
    @include('customer.modal_mod_lav')
@endsection
@section('scripts')
    ...
    <script>
        ...
        function loadCustomer(id) {
            $.ajax({
                ...
                success: function (datos) {
                    ...
                    $('#plateCustomerMod').val(datos['plate']);
                    $('#soatCustomerMod').val(datos['date_soat']);
                    $('#tmCustomerMod').val(datos['date_tm']);
                },
                error : function () {
                    //location = '/login';
                }
        ...
        function crearCliente() {
            ...
            var placa = $("#plateCustomer").val();
            var soat = $("#soatCustomer").val();
            var tm = $("#tmCustomer").val();
        ...
        function modificarCliente() {
            ...
            var placa = $("#plateCustomerMod").val();
            var soat = $("#soatCustomerMod").val();
            var tm = $("#tmCustomerMod").val();
        ...
        function loadCustomers() {
            $.ajax({
                ...
                type: "POST",
                url: "get_customers_status",
                data: {

                },
                success: function (datos) {
                    if( datos['soat_expire_num']>0  && showMensajeSoat ==1){
                        new PNotify({
                            title: 'SOAT pendientes',
                            text: datos['soat_expire'],
                            type: 'info'
                        });
                        showMensajeSoat++;
                    }
                    if( datos['tm_expire_num']>0  && showMensajeTm ==1){
                        new PNotify({
                            title: 'Tecnomecanica pendientes',
                            text: datos['tm_expire'],
                            type: 'info'
                        });
                        showMensajeTm++;
                    }
            ...
            methods    : {
                ...
                loadClientesList:function(){
                    $('#clientes-list-table').DataTable({
                        ...
                        columns: [
                            { data: 'plate', name: 'Descripción', orderable  : false, searchable : false },
                            { data: 'nombre', name: 'Descripción', orderable  : false, searchable : false },
                            { data: 'date_soat', name: 'Descripción', orderable  : false, searchable : false },
                            { data: 'date_tm', name: 'Descripción', orderable  : false, searchable : false },
