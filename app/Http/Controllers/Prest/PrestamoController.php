...
class PrestamoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $ticket->actual =$request->cuota*$request->tiempo;
        $ticket->estado = 1;
    ...
    public function getPrestamos(Request $request)
    {
        ...
        $tickets= Prestamo::select(['id_prestamo as Id', 'id_customer', 'interes', 'monto', 'cuota', 'actual', 'tipo', 'tiempo'])->where('id_partner',Auth::user()->partner_id)->orderBy('id_prestamo','desc');
        //dd($tickets->toSql());
        if ($search) {
